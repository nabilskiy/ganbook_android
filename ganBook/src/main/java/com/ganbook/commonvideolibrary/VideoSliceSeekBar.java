package com.ganbook.commonvideolibrary;
...
public class VideoSliceSeekBar extends ImageView {
    ...
    private int progressMaxDiff = 50; //percentage
...
//                    }
                    ...
                    if(mx <= thumbSliceRightX - thumbSliceHalfWidth - progressMaxDiffPixels && selectedThumb == SELECT_THUMB_LEFT)
                    {
