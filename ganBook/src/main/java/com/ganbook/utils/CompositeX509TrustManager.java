...
public class CompositeX509TrustManager implements X509TrustManager {
    ...
    public CompositeX509TrustManager(KeyStore keyStore) throws KeyStoreException, NoSuchAlgorithmException {
        ...
        x509TrustManager = (X509TrustManager) originalTrustManagers[0];
    }
