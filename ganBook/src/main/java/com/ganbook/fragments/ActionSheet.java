...
import com.ganbook.utils.UIUtils;

public class ActionSheet extends BaseFragment implements OnClickListener {
	...
	private void createItems() {
		...
		if (titles != null) {
			for (int i = 0; i < titles.length; i++) {
				...
				Drawable bg = getOtherButtonBg(titles, i);
				UIUtils.setBackgroundDrawable(bt, bg);
				bt.setText(titles[i]);
		...
		UIUtils.setBackgroundDrawable(bt, mAttrs.cancelButtonBackground);
		...
		UIUtils.setBackgroundDrawable(mPanel, mAttrs.background);
