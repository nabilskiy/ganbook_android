...
//    }
    ...
    public static void setBadge(Context context, int badgeCount) {
    	try { 
    		inner_setBadge(context, badgeCount);
    	}
    	catch (Exception e) {
    		int jj=2354;
    		jj++;
    ...
    private static void inner_setBadge(Context context, int badgeCount) throws ShortcutBadgeException {
...
//        } 
        ...
        } else if (HOME_PACKAGE_SAMSUNG.equals(currentHomePackage) || "com.sec.android.app.twlauncher".equals(currentHomePackage)) {
